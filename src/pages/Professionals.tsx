...
import { Calendar, Search, Star, Filter, ChevronDown } from "lucide-react";
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="container mx-auto px-4 pt-24 pb-12">
        ...
        <p className="text-gray-600 mb-8">
          Encontre os melhores profissionais para o serviço que você precisa
        </p>
        ...
        <div className="text-gray-600 mb-4">
          <p>
            <span className="font-semibold">{filteredProfessionals.length}</span> profissionais encontrados
          </p>
        </div>
              ...
              <CardContent className="p-0">
                <div className="flex flex-col md:flex-row">
                  ...
                  <div className="md:w-2/3 p-6">
                    ...
                    <p className="text-[#4664EA] text-sm mb-3">{professional.specialty}</p>
