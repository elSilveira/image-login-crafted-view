  ...
  return (
    <section className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
      ...
      <Link to="/reviews" className="w-full">
        <Card className="bg-white/70 backdrop-blur hover:shadow-lg transition-all border-iazi-border h-full cursor-pointer">
          <CardContent className="p-4 text-center">
            <Star className="mx-auto h-6 w-6 text-iazi-primary mb-2" />
            <h3 className="text-base font-outfit font-semibold mb-1 text-iazi-text">Avaliações</h3>
            <p className="text-xs font-inter text-iazi-text">
              Veja as avaliações dos profissionais
            </p>
          </CardContent>
        </Card>
      </Link>
